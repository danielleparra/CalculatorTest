...
second_number.send_keys('263')

# Select the operation to be performed
operation_mul = UI.Select(driver.find_element_by_css_selector('[ng-model=operator]')).select_by_value("MULTIPLICATION")
